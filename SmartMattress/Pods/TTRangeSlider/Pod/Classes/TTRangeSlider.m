...
- (void)updateLabelValues {
    ...
    NSInteger minH = self.selectedMinimum / 3600;
    NSInteger minM = (NSInteger)self.selectedMinimum % 3600 / 60;
    
    self.minLabel.string = [NSString stringWithFormat:@"%02d:%02d", minH, minM];
    
    if (self.selectedMaximum == 86399) {
        
        NSInteger maxH = (self.selectedMaximum + 1) / 3600;
        NSInteger maxM = (NSInteger)(self.selectedMaximum + 1) % 3600 / 60;
        
        self.maxLabel.string = [NSString stringWithFormat:@"%02d:%02d", maxH, maxM];
    } else {
        
        NSInteger maxH = self.selectedMaximum / 3600;
        NSInteger maxM = (NSInteger)self.selectedMaximum % 3600 / 60;
