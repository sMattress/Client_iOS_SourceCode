...
- (void)initLabel {
    ...
    CGFloat width = [QRUtil screenBounds].size.width;
    CGFloat height = [QRUtil screenBounds].size.height;
    
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, height * 0.685, width, 40)];
    label.text = @"请对准床垫标签或者说明书上的二维码";
